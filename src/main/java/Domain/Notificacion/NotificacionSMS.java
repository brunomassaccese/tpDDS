...
public class NotificacionSMS {
    ...
    public static void enviarAviso(String numeroDestino, String mensaje) {
        Twilio.init(accountSID, authToken);

        Message message = Message.creator(new PhoneNumber(numeroDestino), new PhoneNumber(numeroOrigen),
                            mensaje).create();
